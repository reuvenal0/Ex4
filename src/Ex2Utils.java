...
/**
 * Ex2Utils - Utility class for spreadsheet calculations and constants.
 *
 * - Stores constants for cell types, error messages, dimensions, and functions.
 * - Provides methods for basic spreadsheet calculations: sum, average, min, max.
 * - Used by Ex2Sheet for evaluating formulas and conditions.
 *
 * This class is stateless and only contains static methods and constants.
 * I added some changes where necessary for Ex4, for example the methods that appear at the end
 */
public class Ex2Utils {
    // Cell Types and Error Codes
